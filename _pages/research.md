...
- ***Causal Inference on Quantiles in High Dimensions: A Bayesian Approach.***
  ...
  <div class="collapsible-content">
    <p style="text-align:justify;font-size:80%;">
      This paper proposes a novel Bayesian Analog of Doubly Robust (BADR) procedure for estimating unconditional Quantile Treatment Effects (QTEs) in observational studies. This estimand offers valuable insights into treatment effect heterogeneity across the outcome distribution. By leveraging Bayesian regularization techniques together with efficient-influence-function-based posterior corrections implemented through Bayesian bootstrap, the proposed framework can effectively handle high-dimensional controls and nonlinear relationships while delivering accurate uncertainty quantification. BADR achieves asymptotic equivalence to efficient frequentist estimators as established by a semiparametric Bernstein–von Mises theorem, which permits flexible nuisance estimation under a double-robust smoothness tradeoff between the propensity score and conditional outcome distribution. Monte Carlo simulations show that BADR estimators yield lower RMSE, more accurate coverage probabilities, and shorter credible interval lengths relative to popular alternative estimators found in the literature. We revisit the role of microcredit expansion and loan access on Moroccan household outcomes, demonstrating how the new method adds value in characterizing heterogeneous distributional impacts on outcomes and detecting changes in overall economic inequality, which is also appealing to other applied contexts.    </p>
  </div>
  </div>
...
- ***Endogenous Selection and Spillovers: Bayesian Inference for Policy-Relevant Causal Effects***
  ...
  <div class="collapsible"> 
    <button class="button-4 collapsible-btn">abstract</button>
    <a class="button-4" href="https://arxiv.org/pdf/2608.25720">pdf</a> 
  <div class="collapsible-content">
    <p style="text-align:justify;font-size:80%;">
